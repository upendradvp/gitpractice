...
# add Availity set
Add-AzureRmAvSetVmToAvailabilitySet -ResourceGroupName "PixelRobots" -VMName $vmName -OsType windows -AvailabilitySet "myAvailabilitySet"
